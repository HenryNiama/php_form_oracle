                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="CE_NOMBRE">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="CE_APELLI" class="form-label fw-bold">APELLIDOS: </label>
                                    <input type="text" class="form-control" id="CE_APELLI">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="CE_RAZONS">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="CE_RUCIC" class="form-label fw-bold">RUC/CEDULA: </label>
                                    <input type="number" class="form-control" id="CE_RUCIC">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="CE_NOMREP">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                <label for="CE_APEREP" class="form-label fw-bold">CE_APEREP: </label>
                                <input type="text" class="form-control" id="CE_APEREP">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="CE_CADOM1">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="CE_CADOM2" class="form-label fw-bold">CE_CADOM2: </label>
                                    <input type="text" class="form-control" id="CE_CADOM2">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="CE_SECDOM">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="CE_CAOFI1" class="form-label fw-bold">CE_CAOFI1: </label>
                                    <input type="text" class="form-control" id="CE_CAOFI1">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="CE_CAOF2">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="CE_SECOFI" class="form-label fw-bold">CE_SECOFI: </label>
                                    <input type="text" class="form-control" id="CE_SECOFI">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="CE_CAENT1">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="CE_CAENT2" class="form-label fw-bold">CE_CAENT2: </label>
                                    <input type="text" class="form-control" id="CE_CAENT2">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="CE_SECENT">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="CE_TELDOM" class="form-label fw-bold">CE_TELDOM: </label>
                                    <input type="number" class="form-control" id="CE_TELDOM">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="CE_TELOFI">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="CE_TELBOD" class="form-label fw-bold">CE_TELBOD: </label>
                                    <input type="number" class="form-control" id="CE_TELBOD">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="CE_FAX">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
